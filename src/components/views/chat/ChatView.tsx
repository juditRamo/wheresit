...
export function ChatView({ householdId, onNavigateToItems }: ChatViewProps) {
    ...
    <div className="chat">
      <div className="chat__messages" ref={listRef}>
        <MessageList
          ...
          isLoading={loading}
          loadingText={ui('chat.thinking', pendingLanguage ?? language)}
        />
      </div>
      {error && (
      ...
      <form onSubmit={handleSubmit} className="chat__input-bar">
        <button
          ...
          aria-label={ui('chat.voice_input', language)}
        ...
        <button
          ...
          aria-label={ui('chat.send', language)}
        >
